...
const System = {
  cacheKeys: {
    footerIcons: "skwirlsai_footer_links",
    supportEmail: "skwirlsai_support_email",
    customAppName: "skwirlsai_custom_app_name",
    canViewChatHistory: "skwirlsai_can_view_chat_history",
    deploymentVersion: "skwirlsai_deployment_version",
  },
  ping: async function () {
